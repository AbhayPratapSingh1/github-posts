    ...
    <header className="sticky top-0 z-10 border-b border-bg-200 bg-bg-50/80 backdrop-blur dark:border-bg-800 dark:bg-bg-950/80">
      <div className="mx-auto flex max-w-3xl items-center justify-between px-3 py-3 sm:px-6 sm:py-4">
          <Link to="/" className="flex items-center gap-2 overflow-hidden">
            ...
            <span className="truncate text-sm font-bold tracking-wide uppercase">{post.title || "Untitled"}</span>
          </Link>
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          {post.github && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-1.5 rounded-md border border-bg-300 px-2 py-1.5 text-sm font-medium hover:bg-bg-100 dark:border-bg-700 dark:hover:bg-bg-900 sm:gap-2 sm:px-3"
            >
              <FaGithub />
          ...
          {action && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-1.5 rounded-md bg-primary-600 px-2 py-1.5 text-sm font-semibold text-white hover:bg-primary-700 sm:gap-2 sm:px-3"
            >
              {action.icon}
