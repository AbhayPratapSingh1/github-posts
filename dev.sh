...
# =============================================================================
# dev.sh - API Performance Testing Script
# =============================================================================
# Runs k6 load tests against all APIs and generates performance reports
#
# Usage:
#   ./dev.sh                    # Run against hosted domain
#   ./dev.sh --local            # Run against local server
#   ./dev.sh --url http://...   # Run against custom URL
#   ./dev.sh --compare          # Compare with previous results
#   ./dev.sh --open             # Open heatmap in browser
# =============================================================================
...
K6_SCRIPT="loadtests/api_test.js"
